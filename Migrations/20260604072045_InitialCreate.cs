    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "General medical consultations", "General Practice" },
                    { 2, "Heart and cardiovascular system", "Cardiology" },
                    { 3, "Skin, hair, and nails", "Dermatology" },
                    { 4, "Bones, joints, and muscles", "Orthopedics" },
                    { 5, "Medical care for children", "Pediatrics" }
                });
